...
def test_export_openapi_writes_workspace_contract(tmp_path) -> None:
    ...
    assert "/api/v1/files/{file_id}/share-links" in schema["paths"]
    assert schema["paths"]["/api/v1/files/{file_id}/share-links"]["post"]["operationId"]
    assert "/api/v1/files/{file_id}/download" in schema["paths"]
    assert schema["paths"]["/api/v1/files/{file_id}/download"]["get"]["operationId"]
    assert "/api/v1/share-links/{token}/download" in schema["paths"]
    assert schema["paths"]["/api/v1/share-links/{token}/download"]["post"]["operationId"]
    ...
    assert "/api/v1/files/recycle-bin" in schema["paths"]
    assert schema["paths"]["/api/v1/files/recycle-bin"]["get"]["operationId"]
    assert "/api/v1/files/{file_id}/restore" in schema["paths"]
    assert schema["paths"]["/api/v1/files/{file_id}/restore"]["post"]["operationId"]
    assert "/api/v1/files/{file_id}/annotations" in schema["paths"]
    assert schema["paths"]["/api/v1/files/{file_id}/annotations"]["get"]["operationId"]
    assert schema["paths"]["/api/v1/files/{file_id}/annotations"]["post"]["operationId"]
    assert "/api/v1/annotations/{annotation_id}/replies" in schema["paths"]
    assert schema["paths"]["/api/v1/annotations/{annotation_id}/replies"]["post"]["operationId"]
    assert "/api/v1/files/{file_id}/annotations/{annotation_id}" in schema["paths"]
    assert schema["paths"]["/api/v1/files/{file_id}/annotations/{annotation_id}"]["delete"]["operationId"]
    assert "/api/v1/notifications" in schema["paths"]
    assert schema["paths"]["/api/v1/notifications"]["get"]["operationId"]
    assert "/api/v1/notifications/{notification_id}/read" in schema["paths"]
    assert schema["paths"]["/api/v1/notifications/{notification_id}/read"]["patch"]["operationId"]
    ...
    assert "/api/v1/teams/{team_id}/messages" in schema["paths"]
    assert schema["paths"]["/api/v1/teams/{team_id}/messages"]["get"]["operationId"]
    assert schema["paths"]["/api/v1/teams/{team_id}/messages"]["post"]["operationId"]
