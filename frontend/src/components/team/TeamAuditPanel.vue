...
<template>
  <aside id="teams" class="grid gap-3.5 scroll-mt-24 max-md:scroll-mt-32" aria-label="团队管理">
            ...
            <div class="flex items-start justify-between gap-3">
              <div class="min-w-0">
                ...
                <p class="m-0 mt-1 line-clamp-2 text-sub text-12px leading-[1.65]">
                  {{ team.description || '暂无描述' }} · {{ team.member_count }} 人
                </p>
              </div>
    ...
    <NCard class="min-w-0 overflow-hidden" size="small">
      ...
      <NEmpty v-else size="small" description="暂无成员信息" />
    </NCard>
