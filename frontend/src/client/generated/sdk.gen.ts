 ...
 * Delete Agent Task
 */
export const deleteAgentTaskApiV2AgentsTasksTaskIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentTaskApiV2AgentsTasksTaskIdDeleteData, ThrowOnError>): RequestResult<DeleteAgentTaskApiV2AgentsTasksTaskIdDeleteResponses, DeleteAgentTaskApiV2AgentsTasksTaskIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteAgentTaskApiV2AgentsTasksTaskIdDeleteResponses, DeleteAgentTaskApiV2AgentsTasksTaskIdDeleteErrors, ThrowOnError>({ url: '/api/v2/agents/tasks/{task_id}', ...options });
 ...
 * Get Workflow
 */
export const getWorkflowApiV2WorkflowsWorkflowIdGet = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowApiV2WorkflowsWorkflowIdGetData, ThrowOnError>): RequestResult<GetWorkflowApiV2WorkflowsWorkflowIdGetResponses, GetWorkflowApiV2WorkflowsWorkflowIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetWorkflowApiV2WorkflowsWorkflowIdGetResponses, GetWorkflowApiV2WorkflowsWorkflowIdGetErrors, ThrowOnError>({ url: '/api/v2/workflows/{workflow_id}', ...options });
 ...
 * Debug Cancel
 */
export const debugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDelete = <ThrowOnError extends boolean = false>(options: Options<DebugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDeleteData, ThrowOnError>): RequestResult<DebugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDeleteResponses, DebugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DebugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDeleteResponses, DebugCancelApiV2WorkflowsWorkflowIdDebugSessionIdDeleteErrors, ThrowOnError>({ url: '/api/v2/workflows/{workflow_id}/debug/{session_id}', ...options });

/**
 * List Workflow Executions
 */
export const listWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGet = <ThrowOnError extends boolean = false>(options: Options<ListWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGetData, ThrowOnError>): RequestResult<ListWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGetResponses, ListWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGetErrors, ThrowOnError> => (options.client ?? client).get<ListWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGetResponses, ListWorkflowExecutionsApiV2WorkflowsWorkflowIdExecutionsGetErrors, ThrowOnError>({ url: '/api/v2/workflows/{workflow_id}/executions', ...options });
 ...
 */
export const listWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGet = <ThrowOnError extends boolean = false>(options: Options<ListWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGetData, ThrowOnError>): RequestResult<ListWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGetResponses, ListWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGetErrors, ThrowOnError> => (options.client ?? client).get<ListWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGetResponses, ListWorkflowVersionsApiV2WorkflowsWorkflowIdVersionsGetErrors, ThrowOnError>({ url: '/api/v2/workflows/{workflow_id}/versions', ...options });

/**
 * Restore Workflow Version
 */
export const restoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePost = <ThrowOnError extends boolean = false>(options: Options<RestoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePostData, ThrowOnError>): RequestResult<RestoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePostResponses, RestoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePostErrors, ThrowOnError> => (options.client ?? client).post<RestoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePostResponses, RestoreWorkflowVersionApiV2WorkflowsWorkflowIdVersionsVersionIdRestorePostErrors, ThrowOnError>({ url: '/api/v2/workflows/{workflow_id}/versions/{version_id}/restore', ...options });
